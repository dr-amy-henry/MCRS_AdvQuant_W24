...
#seperating the plants into native and non-native

# Assuming your data frame is named df and the column is named 'your_column'
Transect <- Transect |>
  
  mutate(Native_Nonnative = case_when(
    `Distance` > 10 & `Previous Veg.` == "No Turf" ~ "NonNative",
    TRUE ~ as.character(Native_Nonnative) ) )
