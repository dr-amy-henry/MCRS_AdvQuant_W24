...
```{r}
Vacuum_Arthropods_RAW <- read_excel("RelandscapingData/Vacuum_‏‏‏‏‏‏‏‏‏‏‏‏‏‏‏‏‏‏‏‏collect_data_arthropods_2019_7.12.21.xlsx", 
    sheet = "DATA", skip = 1)

Vacuum_Sampling_RAW <- read_excel("RelandscapingData/Vacuum Sampling Data.xlsx", 
    sheet = "Sheet1")
...
```{r}
Vacuum_Arthropods <- Vacuum_Arthropods_RAW |>
